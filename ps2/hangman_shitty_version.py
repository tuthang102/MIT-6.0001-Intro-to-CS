...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the
    ...
    while True:
        ...
        if (entered_letter in letters_guessed) == True and warnings_remaining >= 1:
        ...
        elif str.isalpha(entered_letter) == False and warnings_remaining >= 1:
            letters_guessed.append(entered_letter)
            warnings_remaining = warnings_remaining - 1
            ...
            # OUT OF WARNINGS
        elif (str.isalpha(entered_letter) == False) and warnings_remaining == 0:
            letters_guessed.append(entered_letter)
            ...
            if guesses_remaining == 0:
                ...
                break
        elif (entered_letter in letters_guessed) == True and warnings_remaining == 0:
            letters_guessed.append(entered_letter)
            guesses_remaining = guesses_remaining - 1
        ...
        elif (entered_letter in secret_word) == True and (entered_letter in letters_guessed) == False:
            letters_guessed.append(entered_letter)
        ...
        elif (entered_letter in secret_word) == False and str.isalpha(entered_letter) == True and (entered_letter in letters_guessed) == False:
            if entered_letter in vowels:
                ...
                if  guesses_remaining == 0:
                    ...
                    print('Sorry, you ran out of guesses. The word was', secret_word)
                    break
            elif entered_letter in consonants:
                letters_guessed.append(entered_letter)
                guesses_remaining = guesses_remaining - 1
                print('Oops! That letter is not in my word:', get_guessed_word(secret_word, letters_guessed))
                print('-------------')
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while True:
        ...
        # ENTER THE SAME LETTER WITH WARNING REMAINS
        if (entered_letter in letters_guessed) == True and warnings_remaining >= 1 and entered_letter != '*':
            letters_guessed.append(entered_letter)
            warnings_remaining = warnings_remaining - 1
            print('Oops! You\'ve already guessed that letter. You have', warnings_remaining, 'warnings left:',
                  get_guessed_word(secret_word, letters_guessed))
            ...
            # ENTER SYMBOLS & NUMBERS INSTEAD OF LETTERS WITH WARNING REMAINS
        elif str.isalpha(entered_letter) == False and warnings_remaining >= 1 and entered_letter != '*':
            letters_guessed.append(entered_letter)
            warnings_remaining = warnings_remaining - 1
            print('Oops! That is not a valid letter. You have', warnings_remaining, 'warnings left:',
                  get_guessed_word(secret_word, letters_guessed))
            ...
            # OUT OF WARNINGS
        elif (str.isalpha(entered_letter) == False) and warnings_remaining == 0 and entered_letter != '*':
            letters_guessed.append(entered_letter)
            guesses_remaining = guesses_remaining - 1
            print('Oops! That is not a valid letter:', get_guessed_word(secret_word, letters_guessed))
            print('-------------')
            ...
            if guesses_remaining == 0:
                ...
                print('Sorry, you ran out of guesses. The word was', secret_word)
                break
        elif (entered_letter in letters_guessed) == True and warnings_remaining == 0 and entered_letter != '*':
            letters_guessed.append(entered_letter)
            guesses_remaining = guesses_remaining - 1
            print('Oops! You\'ve already guessed that letter:', get_guessed_word(secret_word, letters_guessed))
            print('-------------')
            ...
            # ENTER THE WRONG LETTER
        elif (entered_letter in secret_word) == False and str.isalpha(entered_letter) == True and (
            entered_letter in letters_guessed) == False and entered_letter != '*':
            if entered_letter in vowels:
                letters_guessed.append(entered_letter)
                guesses_remaining = guesses_remaining - 2
                print('Oops! That letter is not in my word:', get_guessed_word(secret_word, letters_guessed))
