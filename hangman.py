...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the 
    ...
    while numGuess > 1:
        ...
        if str.isalpha(entered_letter) == False:
            numWarning = numWarning - 1
            print('Oops! That is not a valid leltter. You have', numWarning, 'warnings left:', get_guessed_word(secret_word,letters_guessed))
        if is_word_guessed(secret_word, letters_guessed) == True:
            ...
            break
        if (entered_letter in secret_word) == True:
            print('-------------')
            print('You have', numGuess, 'guesses left.')
            print('Available letters:', get_available_letters(letters_guessed))
            print('Good guess:', get_guessed_word(secret_word, letters_guessed))
        elif (entered_letter in secret_word) == False and str.isalpha(entered_letter) == True:
            numGuess = numGuess - 1
            print('-------------')
            print('You have', numGuess, 'guesses left.')
            print('Available letters:', get_available_letters(letters_guessed))
